...
public class AzureOpenAITests
{
    ...
    [Fact]
    public void APISimulatorOptions_ShouldHaveAzureDefaults()
    {
    ...
    [Fact]
    public void APISimulatorOptions_ShouldValidateAzureConfiguration_MissingEndpoint()
    {
        var options = new APISimulatorOptions
        {
    ...
    [Fact]
    public void APISimulatorOptions_ShouldValidateAzureConfiguration_MissingDeploymentName()
    {
        var options = new APISimulatorOptions
        {
            OpenAIApiKey = "test-key",
    ...
    [Fact]
    public void APISimulatorOptions_ShouldValidateAzureConfiguration_ValidConfig()
    {
        var options = new APISimulatorOptions
        {
            OpenAIApiKey = "test-key",
    ...
    [Fact]
    public void APISimulatorOptions_ShouldNotRequireAzureConfigWhenNotUsingAzure()
    {
        var options = new APISimulatorOptions
        {
            OpenAIApiKey = "test-key",
    ...
    [Fact]
    public void APISimulatorOptions_AzureApiVersion_ShouldTrimWhitespace()
    {
        var options = new APISimulatorOptions();
    ...
    [Fact]
    public void APISimulatorOptions_AzureApiVersion_ShouldUseDefaultWhenEmpty()
    {
        var options = new APISimulatorOptions();
    ...
    [Fact]
    public void APISimulatorOptions_AzureDeploymentName_ShouldTrimWhitespace()
    {
        var options = new APISimulatorOptions();
    ...
    {
        // Test that simulator can be created with Azure configuration
        // (Note: actual Azure client creation is tested via the configuration)
        var simulator = this.CreateAPISimulator("TestAPI", options =>
        {
            options.OpenAIApiKey = "test-key-for-testing";
            options.UseAzureOpenAI = true;
